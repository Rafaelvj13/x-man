...
temos que adicionar a borda azul de seleção na imagem pequena do personagem e mostrar 
  a imagem, 
    ...
    selecioná-lo  passo 1 - pegar os personagens no JS pra poder verificar quando o usuário 
...
remover a seleção dele  */
    ...
    const desrcicaoPersonagem = document.getElementById("descricao-personagem")
    desrcicaoPersonagem.innerText = personagem.getAttribute("data-description")
